...
public class Battle {
    ...
    private String executeAction(Characters attacker, Characters defender, int skillNum) {
        ...
        // Display the skill number and name (no punchline)
        System.out.println();
        System.out.println(">>> [" + skillNum + "] " + skillName + " <<<");
        System.out.println();

        attacker.useSkill(skillNum, defender);
        System.out.println(); // Add spacing after the action

        return "used [" + skillNum + "] " + skillName;
    }
